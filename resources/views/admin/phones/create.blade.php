...
@section('title', 'Thêm Điện Thoại Mới')

@section('content')

    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Thêm Điện Thoại Mới</h1>
            ...
            <form action="{{ route('admin.phones.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    @error('main_image')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <small class="form-text text-muted">Kích thước đề xuất: 400x600px</small>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="number" step="0.01"
                            ...
                            name="original_price" value="{{ old('original_price') }}" min="0">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control @error('storage_capacity') is-invalid @enderror"
                            id="storage_capacity" name="storage_capacity" value="{{ old('storage_capacity') }}" required>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control @error('status') is-invalid @enderror" id="status" name="status"
                        ...
                        <option value="upcoming" {{ old('status') == 'upcoming' ? 'selected' : '' }}>Sắp ra mắt</option>
                        <option value="disabled" {{ old('status') == 'disabled' ? 'selected' : '' }}>Ngừng kinh doanh
                        </option>
                    </select>
                    @error('status')
                        <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control @error('specs_os') is-invalid @enderror"
                                id="specs_os" name="specs_os" value="{{ old('specs_os') }}">
                            @error('specs_os')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control @error('specs_chip') is-invalid @enderror"
                                id="specs_chip" name="specs_chip" value="{{ old('specs_chip') }}">
                            @error('specs_chip')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control @error('specs_camera') is-invalid @enderror"
                                id="specs_camera" name="specs_camera" value="{{ old('specs_camera') }}">
                            @error('specs_camera')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control @error('specs_screen') is-invalid @enderror"
                                id="specs_screen" name="specs_screen" value="{{ old('specs_screen') }}">
                            @error('specs_screen')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control @error('specs_battery') is-invalid @enderror"
                                id="specs_battery" name="specs_battery" value="{{ old('specs_battery') }}">
                            @error('specs_battery')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
